...
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_openssl_update, 0, 0, 2)
    ZEND_ARG_INFO(0, ctx)
...
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_openssl_ctx_only, 0, 0, 1)
    ZEND_ARG_INFO(0, ctx)
ZEND_END_ARG_INFO()
ZEND_BEGIN_ARG_INFO_EX(arginfo_openssl_crypt_init, 0, 0, 2)
    ZEND_ARG_INFO(0, method)
...
const zend_function_entry openssl_functions[] = {
	...
	PHP_FE(openssl_digest_update,				arginfo_openssl_update)
	PHP_FE(openssl_digest_final,				arginfo_openssl_digest_final)
	PHP_FE(openssl_digest_copy,				arginfo_openssl_ctx_only)
	...
	PHP_FE(openssl_encrypt_init,				arginfo_openssl_crypt_init)
	PHP_FE(openssl_encrypt_update,				arginfo_openssl_update)
	PHP_FE(openssl_encrypt_final,				arginfo_openssl_ctx_only)
